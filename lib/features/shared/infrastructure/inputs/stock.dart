...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if (displayError == StockError.empty) return 'Required';
    if (displayError == StockError.value) return 'Must be 0 or greater';
    if (displayError == StockError.format) return 'Doesnt have number format';
