...
//PANTALLA AL PRESIONAR UN PRODUCTO
class ProductScreen extends ConsumerWidget {
  ...
  void showSnackBar(BuildContext context) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Product Udpated succesfully'),
      ),
    );
  }
        ...
        children: [
          ...
          CustomProductField(
            ...
            onChanged: ref
                ...
                .onTitleChanged, //solo referencia a la funcion
  ...
  Widget build(BuildContext context) {
    ...
    return PageView(
      ...
      children: images.map((image) {
        late ImageProvider
            imageProvider; //late porque eventualmente va a venir una imagen en algun momento

        if (image.startsWith('http')) {
          //si la imagen viene de una fuente externa entonces:
          imageProvider = NetworkImage(image);
        } else {
          //sino, si es una imagen del dispositivo local, busque ese url en el file system
